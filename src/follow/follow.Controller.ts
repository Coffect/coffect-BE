...
export class FollowController extends Controller {
  ...
  @Response<ITsoaErrorResponse>(404, 'Bad Request', {
    resultType: 'FAIL',
    error: {
      errorCode: 'FE404',
  ...
  public async FollowRequest(
    ...
    const result = await this.FollowService.FollowRequestService(
      userId,
      oppentUserId
    );
  ...
  public async isFollow(
    ...
    const result = await this.FollowService.isFollowService(
      userId,
      oppentUserId
    );
...
export class specifyProfileController extends Controller {
  ...
  public async ShowFeedCount(
    ...
    const result =
      await this.specifyProfileService.ShowFeedCountService(userId);
